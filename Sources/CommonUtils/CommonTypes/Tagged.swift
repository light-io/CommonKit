//
// Created by Alexander Lakhonin on 27.09.2021.
...
public struct Tagged<Tag, RawValue> {
  ...
  public func map<NewRaw>(_ converter: (RawValue) -> NewRaw) -> Tagged<Tag, NewRaw> {
    .init(rawValue: converter(self.rawValue))
  }
}
...
extension Tagged: Strideable where RawValue: Strideable {
  ...
  public func advanced(by stride: RawValue.Stride) -> Tagged<Tag, RawValue> {
    Tagged(rawValue: self.rawValue.advanced(by: stride))
  }
}
...
public extension Tagged {
  func coerced<Tag2>(to type: Tag2.Type) -> Tagged<Tag2, RawValue> {
